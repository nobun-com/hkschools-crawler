...
public class SSEntity {
	...
	String yearOfSchool;
	String RelatedPrimarySchool;
	String SchoolTeachingLanguage;
	...
	public String getSpecialRooms() {
		return specialRooms;
	}
	public void setSpecialRooms(String specialRooms) {
	...
	public String getSchoolTeachingLanguage() {
		return SchoolTeachingLanguage;
	}
	public void setSchoolTeachingLanguage(String schoolTeachingLanguage) {
		SchoolTeachingLanguage = schoolTeachingLanguage;
	}
	public Long getId() {
		return id;
	}
	...
	public void setWorkExperience5_9Years(String workExperience59Years) {
	...
	public String getRelatedPrimarySchool() {
		return RelatedPrimarySchool;
	}
	public void setRelatedPrimarySchool(String relatedPrimarySchool) {
		RelatedPrimarySchool = relatedPrimarySchool;
	}
